...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final SharedPreferences sharedPreferencesPhone = this.getActivity().getSharedPreferences(Config.SHARED_PREF_PHONE,
                Context.MODE_PRIVATE);
        final SharedPreferences sharedPreferencesEmail = this.getActivity().getSharedPreferences(Config.SHARED_PREF_EMAIL,
                Context.MODE_PRIVATE);
